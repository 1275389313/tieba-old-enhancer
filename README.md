...
| 脚本 | 版本 | 说明 |
|------|------|------|
| [tieba-long-image-auto-expand.user.js](tieba-long-image-auto-expand.user.js) | 0.3.1 | ① 自动展开长图为完整图片；② 自动展开全部楼中楼回复（免点"查看更多回复"）；③ 隐藏页面右侧推广/辅助按钮（辅助模式、下载APP、魔法道具、神来一句、分享、我要反馈）及"爱逛的吧"模块，并监听 AJAX 动态加载的楼层 |
